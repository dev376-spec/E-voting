...
<ul id="css3menu1" class="topmenu">
  ...
  <div id="bo__dy">
     <div id="bo__dy_pub">
	   ...
	   <div id="recents">
	      <img src="files/modi.jpg" />
	     <p>Narendra Modi reached America after visiting Ireland. A huge crowd was there to welcome Modi<br /><A href=http://www.google.com/news> Read full Story</A> Modi In America</p>
	   </div>
	...
	<div id="bo__dy_conts">
	    <div id="HEa__DER"><h2> What is E-voting</h2></div>
		<div id="PiC__cont">
		   <ul class="imageslider" style="margin-left:0px;">
		      <li class="slide"><img src="files/new2.jpg" /></li>
			  <li class="slide"><img src="files/new3.jpg" /></li			  ><li class="slide"><img src="files/new4.jpg" /></li>
>
			  <li class="slide"><img src="files/78.jpg" /></li>
		   </ul>
		 </div>
		<div id="CO__nt">
		    <p  style="box-shadow:0px 0px 5px #000;">E-voting stands for electronic voting is a term encompassing several different types of voting embrancing both electronic means of costing a vote and electronic means of counting votes our application tried to enable every body to use it in easily way and transparency, this will avoid desorder of traditional voting.</p>
		</div>
	 </div>
  </div>
